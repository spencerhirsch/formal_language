...
\section{Grammars}
Grammar can be used to describe behavior of groups of speakers, the use of grammar demonstrates not only the knowledge of
an individual but also the characteristics of speech of an entire group.
